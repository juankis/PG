...
/* Created on:     8/2/2014 6:48:33 PM                          */
/*==============================================================*/
...
drop table PUBLIC2.COLCHON;

drop index DEPOSITO_PK;

drop table PUBLIC2.DEPOSITO;
...
drop table PUBLIC2.ENTRADA;

drop index ESPONJA_PK;

drop table PUBLIC2.ESPONJA;

drop index MEDIDAS_PK;

drop table PUBLIC2.MEDIDAS;
...
drop table PUBLIC2.RELACIONENTRADASALIDA;

drop index RELATIONSHIP_5_FK;

drop index SALIDA_PK;

drop table PUBLIC2.SALIDA;
...
create table PUBLIC2.ENTRADA (
   ...
   TIPOENTRADA          CHAR(256)            null,
   FECHAENTRADA         CHAR(256)            null,
   DETALLEENTRADA       CHAR(10)             null,
...
/*==============================================================*/
create table PUBLIC2.RELACIONENTRADASALIDA (
